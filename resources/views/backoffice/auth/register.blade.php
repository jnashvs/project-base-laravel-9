@extends('backoffice.layouts.user-auth')
                        ...
                        <div class="card mt-12">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}" role="form text-left">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Name" name="name" aria-label="Name" aria-describedby="email-addon">
                                        @error('name')
                                    ...
                                    <div class="form-check form-check-info text-left">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            I agree the <a href="javascript:;" class="text-success text-gradient font-weight-bolder">Terms and Conditions</a>
                                        </label>
                                    </div>

            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Views</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <h5 class="font-weight-bolder">Dash UI Dashboard</h5>
                                <p class="mb-5">Kick start your Laravel Project with Dash Ui, this include - User Management, Roles & Permission Functionality, Charts and Built in components.</p>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Adobe XD Version</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
